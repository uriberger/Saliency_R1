        ...
        if not gather_deepspeed3_params:
            ...
            with deepspeed.zero.GatheredParameters(model.parameters()):
                ...
                try:
                    ...
                    # Re-register the ZeRO-3 fetch/partition hooks even if the yielded
                    # block raises; otherwise the policy would keep training with its
                    # hooks stripped, corrupting subsequent forward/backward passes.
                    add_hooks(model)
    else:
